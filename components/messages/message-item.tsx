      ...
      <ContextMenuTrigger asChild>
        ...
        >
          ...
          >
            {!isOwn &&
              (showSender ? (
                <Avatar className="ring-background mt-4 h-8 w-8 shrink-0 ring-2">
                  <AvatarImage
            ...
            >
              {showSender && !isOwn && (
                <p className="text-primary mb-1 px-3 text-xs font-semibold">
                ...
                {message.type === "IMAGE" || message.type === "FILE" ? (
                  <div className="space-y-1">
                    ...
                    {message.fileUrl && message.type === "FILE" && (
                      <a
                        ...
                        className={cn(
                          "flex min-w-0 items-center gap-2 text-sm break-words underline",
                  ...
                  <div className="flex min-w-0 items-center gap-1">
                    <Input
                      ...
                      className="h-8 min-w-0 text-sm sm:min-w-[220px]"
                      autoFocus
                      onKeyDown={(e) => {
              ...
              <TooltipProvider delayDuration={200}>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <div
                      className={cn(
                        "text-muted-foreground mt-1 flex items-center gap-1 px-2 text-xs opacity-0 transition-opacity group-hover:opacity-100",
                        isOwn && "justify-end",
                      )}
                    >
                      {messageStatus && isOwn && (
